...
public class Solution {
    ...
    public static void reset() {
        ...
        try {
            String planeOrHelicopter = reader.readLine();
            if (planeOrHelicopter.equals("helicopter")) result = new Helicopter();
            if (planeOrHelicopter.equals("plane")){
                try {
                    int numOfPassangers = Integer.parseInt(reader.readLine());
                    result = new Plane(numOfPassangers);
                }catch (IOException e){
